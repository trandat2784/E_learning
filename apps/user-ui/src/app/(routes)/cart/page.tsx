...
const CartPage = () => {
    ...
    const [discountPercent, setDiscountedPercent] = React.useState(0)
    const [discountAmount, setDiscountedAmount] = React.useState(0)
        ...
        <div className={"w-full bg-white"}>
            <div className={"md:w-[80%] w-[95%] mx-auto min-h-screen"}>
                <div className={"pb-[50px]"}>
                    ...
                    <Link className={"text-[#55585b] hover:underline"} href={`/`}>
                        Home
                    </Link>
                            ...
                            <div className={"p-6 shadow-md w-full lg:w-[30%] bg-[#f9f9ff9] rounded-lg "}>
                                {
                                    discountAmount > 0 && (
                                        <div
                                            className={"flex justify-between items-center text-[#010f1c] text-base font-medium pb-1"}>
                                ...
                                <div className={"mb-4"}>
                                    ...
                                    <div className={"mb-4 "}>
                                        ...
                                        >
                                            <option value="1-2-3">Home-New York-USA</option>
                                        </select>
                                    </div>
                                    <hr className={"my-4 text-slate-200"}/>
                                    <div className={"mb-4"}>
