...
const orders = [
    ...
    {id: "ORD-002", customer: "John Doe", amount: "$250", status: "Pending"},
    {id: "ORD-003", customer: "Bob Lee", amount: "$50", status: "Failed"},
...
const columns = [
    ...
    },
    {
        ...
        cell: (({getValue}: any) => {
            ...
            const color = value == "Paid" ? "text-green-400"
                : value == "Pending" ? "text-yellow-400" : "text-red-400"
                ...
                <table className={"min-w-full text-sm text-white"}>
                    ...
                    <tbody className={"bg-transparent"}>
                    {
                        table.getRowModel().rows.map((row: any) => (
                            <tr className={"border-t border-slate-600 hover:border-slate-800 transition"}>
                                {
